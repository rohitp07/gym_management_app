...
class PlayerOtherDetails extends StatefulWidget {
  String phone;
  PlayerOtherDetails(this.phone);
  @override
...
class StartState extends State<PlayerOtherDetails> {
  ...
  readData() async {
    ...
    if (docSnapshot.exists) {
      ...
      setState(() {
        ...
        medicalIssue=data?['Medical Issues'];
      });
  ...
  TextEditingController medicalprb = TextEditingController();
  ...
  Future addPlayerMemberPersonalDetails() async {
    ...
    final json = {
      ...
      'Medical Issues': medicalprb.text,
    };
          ...
          child: Column(children: <Widget>[
            ...
            Padding(
              ...
              child: Container(
                ...
                child: TextField(
                  controller: medicalprb..text=medicalIssue??"",
                  style: TextStyle(color: Colors.white),
                  cursorColor: Color(0xFFC4C4C4),
                  decoration: InputDecoration(
                    suffixIcon:
            ...
            Container(
              ...
              child: ElevatedButton(
                  onPressed: () async {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Player_home(phone)),
                    );
                  },
                  child: Text(
                    'Save',
