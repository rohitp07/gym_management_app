...
import 'package:gym222/screens/notifications/notificationsmembers.dart';

import '../notifications/notificationadmin.dart';
import 'newsadd.dart';
import 'newsdatabase.dart';

class NewsMembers extends StatefulWidget {
...
class StartState extends State<NewsMembers> {
  late Database db;
  List docs = [];
  initialise() {
    db = Database();
