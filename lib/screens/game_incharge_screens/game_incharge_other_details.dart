...
class GameInchargeOtherDetails extends StatefulWidget {
  String phone;
  GameInchargeOtherDetails(this.phone);
  @override
...
class StartState extends State<GameInchargeOtherDetails> {
  ...
  Future addGameInchargePersonalDetails() async {
    final docUser = FirebaseFirestore.instance
        .collection('Game Incharge')
          ...
          child: Column(children: <Widget>[
            ...
            Container(
              ...
              child: ElevatedButton(
                  onPressed: () async {
                    await addGameInchargePersonalDetails();
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => GameIncharge_home(phone)),
                    );
                  },
                  child: Text(
                    'Save',
